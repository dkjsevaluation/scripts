...
#' @example backup.lamapoll("online", "C:/Users/Alexander Wedel/OneDrive - Deutsche Kinder- und Jugendstiftung/Auswertung/Programmliste.xlsx", ""C:/Users/Alexander Wedel/OneDrive - Deutsche Kinder- und Jugendstiftung/Auswertung/Backup/", "xyz1234")
#' @import openxlsx
#' @import httr
#' @import fs
#' @import jsonlite
...
backup.lamapoll <- function(xstatus, xdir, ydir, apikey) {
  ...
  if (xstatus == "online" || xstatus == "offline") {
    ...
    programmliste <- read.xlsx(ydir, startRow = 1)
